...
MESSAGES = {
    ...
    "Import introuvable ou expiré.": "Import not found or expired.",
    "Cet import a expiré : ajoutez de nouveau les fichiers.": "This import has expired: add the files again.",
    "Cet import est déjà confirmé.": "This import is already confirmed.",
    "Choisissez une série existante ou nommez la nouvelle série.": "Choose an existing series or name the new series.",
    "Série introuvable.": "Series not found.",
    "Cette série est archivée : restaurez-la avant d’y ajouter du contenu.": "This series is archived: restore it before adding content to it.",
    "Volume introuvable dans cette série.": "Volume not found in this series.",
    "Ce volume est archivé : restaurez-le avant d’y ajouter des chapitres.": "This volume is archived: restore it before adding chapters to it.",
    "L’import ne peut pas être confirmé.": "The import cannot be confirmed.",
    "Série introuvable ou accès insuffisant.": "Series not found or insufficient access.",
    "Cette série contient un flux continu de chapitres : elle reste une webnovel.": "This series holds a continuous flow of chapters: it stays a webnovel.",
    "Supprimez ou détachez d’abord les volumes de cette série.": "First delete or detach the volumes of this series.",
    "Terminez ou annulez le travail des volumes avant d’archiver cette série.": "Finish or cancel the work on the volumes before archiving this series.",
    "Des chapitres TXT ou JSON appartiennent obligatoirement à une série.": "TXT or JSON chapters must belong to a series.",
    "Series Bible trop volumineuse.": "Series Bible too large.",
    "Ce terme existe déjà dans le glossaire de la série.": "This term already exists in the series glossary.",
    "Identité introuvable.": "Identity not found.",
    "Une autre identité de la série porte déjà ce nom : fusionnez-les plutôt.": "Another identity of the series already has this name: merge them instead.",
    "Fusion impossible : choisissez des identités distinctes de même nature.": "Merge impossible: choose distinct identities of the same kind.",
    "Lien introuvable pour cette identité.": "Link not found for this identity.",
    "Le flux continu de chapitres n’a pas de numéro de volume.": "The continuous chapter flow has no volume number.",
    ...
    "Code de langue invalide : utilisez une étiquette BCP 47 (en, fr-FR, zh-Hant…).": "Invalid language code: use a BCP 47 tag (en, fr-FR, zh-Hant…).",
    "Indiquez la série : son identifiant ou son nom.": "Give the series: its identifier or its name.",
    "Le contenu du chapitre est vide.": "The chapter's content is empty.",
    "Requête de traduction invalide.": "Invalid translation request.",
    "Le corps de la requête n’est pas un JSON UTF-8 valide.": "The request body is not valid UTF-8 JSON.",
    "Le corps de la requête doit être un objet JSON.": "The request body must be a JSON object.",
    "Donnez un nom au jeton.": "Give the token a name.",
    "Jeton introuvable.": "Token not found.",
    "Jeton d’API manquant : envoyez « Authorization: Bearer <jeton> ».": "Missing API token: send “Authorization: Bearer <token>”.",
    "Jeton d’API inconnu.": "Unknown API token.",
    "Ce jeton d’API a été révoqué.": "This API token has been revoked.",
    "Ce jeton d’API a expiré.": "This API token has expired.",
    "Le compte de ce jeton est désactivé.": "The account of this token is disabled.",
    "Trop de requêtes pour ce jeton : réessayez plus tard.": "Too many requests for this token: try again later.",
    "Le contenu enregistré de cette requête est introuvable.": "The stored content of this request cannot be found.",
    "Des chapitres existent déjà avec un autre contenu : envoyez « replace_changed_chapters: true » pour les remplacer.": "Chapters already exist with a different content: send “replace_changed_chapters: true” to replace them.",
    "Le volume de cette requête a été supprimé.": "The volume of this request was deleted.",
    "Le travail de cette requête a été supprimé.": "The job of this request was deleted.",
    "Une autre requête a déjà utilisé cette clé d’idempotence ou cet external_id avec un contenu différent.": "Another request already used this idempotency key or external_id with a different content.",
    "Aucun provider pour ce volume : indiquez pipeline.provider_id.": "No provider for this volume: set pipeline.provider_id.",
    "Envoyez un seul fichier JSON dans le champ « file ».": "Send a single JSON file in the “file” field.",
    "Le fichier envoyé doit être un fichier .json.": "The uploaded file must be a .json file.",
    "Envoyez application/json, ou un fichier .json en multipart/form-data.": "Send application/json, or a .json file as multipart/form-data.",
    "Requête de traduction introuvable.": "Translation request not found.",
    "Cette requête n’a pas de travail en cours : rien à mettre en pause ou à reprendre.": "This request has no job: nothing to pause or resume.",
    "La traduction de cette requête n’est pas terminée : réessayez plus tard, ou demandez un résultat partiel (partial=true).": "The translation of this request is not finished: try again later, or ask for a partial result (partial=true).",
...
TEMPLATES = {
    ...
    "Ce fichier n’est pas un {format} : « {name} ».": "This file is not a {format}: “{name}”.",
    "Un import accepte au plus {count} fichiers.": "An import accepts at most {count} files.",
    "Import trop volumineux : {limit} Mo au maximum.": "Import too large: {limit} MB at most.",
    "Une série « {name} » existe déjà.": "A series “{name}” already exists.",
    "Numéros de volume en double : {numbers}.": "Duplicate volume numbers: {numbers}.",
    "Le volume {number} existe déjà dans cette série.": "Volume {number} already exists in this series.",
    "Fichier n° {index} inconnu dans cet import.": "File no. {index} is not part of this import.",
    "« {name} » est illisible : retirez-le de l’import.": "“{name}” cannot be read: remove it from the import.",
    "« {name} » est déjà dans votre bibliothèque ou dans ce lot : retirez-le.": "“{name}” is already in your library or in this batch: remove it.",
    "Indiquez le numéro de volume de « {name} ».": "Enter the volume number of “{name}”.",
    "Confirmez le numéro de volume de « {name} » : il n’a pas pu être déduit avec certitude.": "Confirm the volume number of “{name}”: it could not be inferred with certainty.",
    "Le volume {number} apparaît plusieurs fois dans ce lot.": "Volume {number} appears several times in this batch.",
    "Le volume {number} existe déjà dans « {series} » : « {title} ».": "Volume {number} already exists in “{series}”: “{title}”.",
    "« {name} » est en double dans ce lot : retirez-le.": "“{name}” appears twice in this batch: remove it.",
    "Indiquez le numéro de chapitre de « {name} » ou confirmez qu’il n’en a pas.": "Enter the chapter number of “{name}” or confirm that it has none.",
    "Confirmez le numéro de chapitre de « {name} ».": "Confirm the chapter number of “{name}”.",
    "Le chapitre {number} apparaît plusieurs fois dans ce lot.": "Chapter {number} appears several times in this batch.",
    ...
    "Le chapitre {number} apparaît plusieurs fois dans la requête.": "Chapter {number} appears more than once in the request.",
    "L’identifiant de chapitre « {identifier} » apparaît plusieurs fois dans la requête.": "Chapter identifier “{identifier}” appears more than once in the request.",
    "Trop de chapitres : {count} au maximum par requête.": "Too many chapters: at most {count} per request.",
    "Au plus {count} jetons non révoqués par compte : révoquez-en un.": "At most {count} unrevoked tokens per account: revoke one.",
    "Ce jeton n’a pas la permission « {scope} ».": "This token does not have the “{scope}” permission.",
    "Le volume {number} de cette série a un autre identifiant externe.": "Volume {number} of this series has another external identifier.",
    "En-tête Idempotency-Key invalide : 1 à {count} caractères imprimables.": "Invalid Idempotency-Key header: 1 to {count} printable characters.",
