...
MESSAGES = {
    ...
    "Décision sur une proposition inconnue.": "Decision on an unknown proposal.",
    "Paragraphes inconnus ou répétés dans les unités corrigées.": "Unknown or repeated paragraphs in the corrected units.",
    "Texte modifié alors qu’aucune proposition n’est retenue.": "Text changed although no proposal is accepted.",
    "Passage trop long pour une traduction phrase par phrase.": "Passage too long for a sentence-by-sentence translation.",
