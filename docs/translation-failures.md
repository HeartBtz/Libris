...
- Après **5 réponses invalides** sur un passage (paragraphes ou marqueurs altérés, format inexploitable), Libris conserve le texte existant, signale une erreur et poursuit le passage suivant.
