...
- 81 tests backend réussis : import/reconstruction, accès, providers, concurrence indépendante par provider, Codex, reprise, interruptions, refus avec poursuite du livre et provider de remplacement, acceptation des propositions IA, couverture, identités, graphes et catalogues.
