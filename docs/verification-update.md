...
- 106 tests backend réussis : import/reconstruction, accès, providers, concurrence indépendante par provider, changement de provider après pause, Codex, reprise, interruptions, refus avec poursuite du livre et provider de remplacement, récupération obligatoire avant revue finale, acceptation ou rejet des propositions IA, couverture, identités, graphes, catalogues, séries, archivage réversible, progression canonique et revue finale bornée (corrections vérifiées, choix humains protégés, reprise et SearXNG facultatif).
