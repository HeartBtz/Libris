...
export function App() {
  ...
  useEffect(() => {
    document.title = `${route === "settings" ? t("app.settings") : route === "statistics" ? t("app.statistics") : route === "account" ? t("Mon compte") : route === "queue" ? t("File d’attente") : route === "library" ? t("app.library") : route.startsWith("series/") ? t("Série") : t("app.project")} · Libris`;
  }, [route, t]);
